...
class ServiceProfilesApi
{
     ...
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Emnify\EmnifySdk\Model\RetrieveaSingleServiceProfileresponse
     */
     ...
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Emnify\EmnifySdk\Model\RetrieveaSingleServiceProfileresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceProfileByProfileIdGetWithHttpInfo($profile_id)
    {
        $returnType = '\Emnify\EmnifySdk\Model\RetrieveaSingleServiceProfileresponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Emnify\EmnifySdk\Model\RetrieveaSingleServiceProfileresponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Emnify\EmnifySdk\Model\UpdateServiceProfile $body body (required)
     * @param  float $profile_id The Numeric ID of a Service Profile (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Update Service Profile
     *
     * @param  \Emnify\EmnifySdk\Model\UpdateServiceProfile $body (required)
     * @param  float $profile_id The Numeric ID of a Service Profile (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Emnify\EmnifySdk\Model\RetrieveServiceProfileListresponse[]
     */
     ...
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Emnify\EmnifySdk\Model\RetrieveServiceProfileListresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceProfileGetWithHttpInfo()
    {
        $returnType = '\Emnify\EmnifySdk\Model\RetrieveServiceProfileListresponse[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Emnify\EmnifySdk\Model\RetrieveServiceProfileListresponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Emnify\EmnifySdk\Model\CreateaServiceProfilerequest $body body (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Create Service Profile
     *
     * @param  \Emnify\EmnifySdk\Model\CreateaServiceProfilerequest $body (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
