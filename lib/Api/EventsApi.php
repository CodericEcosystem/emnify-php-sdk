...
class EventsApi
{
     ...
     * @return \CodericEcosystem\EmnifySdk\Model\RetrieveEventTypesresponse[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\RetrieveEventTypesresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function eventTypeGetWithHttpInfo()
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\RetrieveEventTypesresponse[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\RetrieveEventTypesresponse[]',
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\Event[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\Event[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getEventsWithHttpInfo($page = null, $per_page = null, $sort = null, $q = null)
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\Event[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\Event[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
