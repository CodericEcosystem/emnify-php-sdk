...
class ApplicationTokensApi
{
     ...
     *
     * @param  \Emnify\EmnifySdk\Model\ApplicationToken $body body (required)
     ...
     * Update Application Token
     *
     * @param  \Emnify\EmnifySdk\Model\ApplicationToken $body (required)
     * @param  float $app_token_id application token ID (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Emnify\EmnifySdk\Model\ListofApplicationTokensresponse[]
     */
     ...
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Emnify\EmnifySdk\Model\ListofApplicationTokensresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function applicationTokenGetWithHttpInfo()
    {
        $returnType = '\Emnify\EmnifySdk\Model\ListofApplicationTokensresponse[]';
     ...
     *
     * @param  \Emnify\EmnifySdk\Model\CreateApplicationTokenrequest $body body (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Emnify\EmnifySdk\Model\CreateApplicationTokenresponse
     */
     ...
     * Create Application Token
     *
     * @param  \Emnify\EmnifySdk\Model\CreateApplicationTokenrequest $body (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Emnify\EmnifySdk\Model\CreateApplicationTokenresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applicationTokenPostWithHttpInfo($body)
    {
        $returnType = '\Emnify\EmnifySdk\Model\CreateApplicationTokenresponse';
