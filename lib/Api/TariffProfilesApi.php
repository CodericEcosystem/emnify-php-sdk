...
class TariffProfilesApi
{
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\TariffProfile2
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\TariffProfile2, HTTP status code, HTTP response headers (array of strings)
     */
    public function tariffProfileByIdGetWithHttpInfo($tariff_profile_id)
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\TariffProfile2';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\TariffProfile2',
     ...
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\PatchTariffProfilerequest $body body (required)
     * @param  float $tariff_profile_id The numeric ID of a Tariff Profile (required)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Update Tariff Profile
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\PatchTariffProfilerequest $body (required)
     * @param  float $tariff_profile_id The numeric ID of a Tariff Profile (required)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\RetrieveCoverageresponse[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\RetrieveCoverageresponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function tariffProfileCoverageByTpIdGetWithHttpInfo($tariff_profile_id)
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\RetrieveCoverageresponse[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\RetrieveCoverageresponse[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\TariffProfile1[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\TariffProfile1[], HTTP status code, HTTP response headers (array of strings)
     */
    public function tariffProfileGetWithHttpInfo()
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\TariffProfile1[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\TariffProfile1[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\CreateTariffProfilerequest $body body (required)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Create Tariff Profile
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\CreateTariffProfilerequest $body (required)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
