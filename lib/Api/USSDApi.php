...
class USSDApi
{
     ...
     * Create USSD dialog
     *
     * @param  \Emnify\EmnifySdk\Model\StartingaUSSDDialogrequest $body body (required)
     * @param  int $endpoint_id Numeric ID of an endpoint (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Emnify\EmnifySdk\Model\StartingaUSSDDialogresponse
     */
     ...
     * Create USSD dialog
     *
     * @param  \Emnify\EmnifySdk\Model\StartingaUSSDDialogrequest $body (required)
     * @param  int $endpoint_id Numeric ID of an endpoint (required)
     *
     * @throws \Emnify\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Emnify\EmnifySdk\Model\StartingaUSSDDialogresponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function endpointUssdByIdPostWithHttpInfo($body, $endpoint_id)
    {
        $returnType = '\Emnify\EmnifySdk\Model\StartingaUSSDDialogresponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Emnify\EmnifySdk\Model\StartingaUSSDDialogresponse',
