...
class CloudConnectApi
{
     ...
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\CreateCloudConnectTGWRequest $body body (optional)
     *
     ...
     * Create a CloudConnect attachment via Transit Gateway
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\CreateCloudConnectTGWRequest $body (optional)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\CreateCloudConnectVPNRequest1 $body body (optional)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Create a CloudConnect attachment via IPSec VPN
     *
     * @param  \CodericEcosystem\EmnifySdk\Model\CreateCloudConnectVPNRequest1 $body (optional)
     *
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\InlineResponse20010[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\InlineResponse20010[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCloudConnectAttachmentsWithHttpInfo($status = null, $type = null, $organisation = null)
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\InlineResponse20010[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\InlineResponse20010[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\InlineResponse20011[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\InlineResponse20011[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCloudConnectAvailableRegionsByBreakoutTypeWithHttpInfo($breakout_type_id)
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\InlineResponse20011[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\InlineResponse20011[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CodericEcosystem\EmnifySdk\Model\CloudConnectBreakoutType[]
     */
     ...
     * @throws \CodericEcosystem\EmnifySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CodericEcosystem\EmnifySdk\Model\CloudConnectBreakoutType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCloudConnectBreakoutTypesWithHttpInfo()
    {
        $returnType = '\CodericEcosystem\EmnifySdk\Model\CloudConnectBreakoutType[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CodericEcosystem\EmnifySdk\Model\CloudConnectBreakoutType[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
