...
/**
 * RetrieveEventsresponse4 Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class RetrieveEventsresponse4 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetrieveEventsresponse4';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['event_severity'] === null) {
            $invalidProperties[] = "'event_severity' can't be null";
        }
