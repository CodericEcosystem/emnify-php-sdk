...
/**
 * GetHourlyOrganisationStatsResponseSms Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class GetHourlyOrganisationStatsResponseSms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Get hourly organisation stats response_sms';
     ...
     * Sets rx
     *
     * @param string[] $rx SMS MO - Array index `0`: Time as `HH:mm` string, index `1`: consumed volume
     *
     * @return $this
     */
     ...
     * Sets tx
     *
     * @param string[] $tx SMS MT - Array index `0`: Time as `HH:mm` string, index `1`: consumed volume
     *
     * @return $this
     */
