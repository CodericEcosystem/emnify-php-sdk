...
/**
 * CreateTariffProfilerequest Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class CreateTariffProfilerequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTariffProfilerequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tariff'] === null) {
            $invalidProperties[] = "'tariff' can't be null";
        }
