...
/**
 * ActionOnExhaustion Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class ActionOnExhaustion implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ActionOnExhaustion';
    ...
    const ID_1 = 1;
    const ID_2 = 2;
    const DESCRIPTION_THROTTLE = 'Throttle';
    const DESCRIPTION_BLOCK = 'Block';
