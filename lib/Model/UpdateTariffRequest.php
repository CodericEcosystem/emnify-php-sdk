...
/**
 * UpdateTariffRequest Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class UpdateTariffRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateTariffRequest';
     ...
     * Sets id
     *
     * @param float $id ID of the new tariff
     *
     * @return $this
     */
