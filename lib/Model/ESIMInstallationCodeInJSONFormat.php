...
/**
 * ESIMInstallationCodeInJSONFormat Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class ESIMInstallationCodeInJSONFormat implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'eSIM installation code in JSON format';
     ...
     * Sets iccid
     *
     * @param string $iccid ICCID of the selected SIM
     *
     * @return $this
     */
     ...
     * Sets payload
     *
     * @param string $payload Installation code of the selected SIM
     *
     * @return $this
     */
