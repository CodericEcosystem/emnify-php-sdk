...
/**
 * RetrieveAvailableDataBlocksizesresponse Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class RetrieveAvailableDataBlocksizesresponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetrieveAvailableDataBlocksizesresponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['octets'] = isset($data['octets']) ? $data['octets'] : null;
    ...
    {
        return $this->container['octets'];
    }

    /**
     * Sets octets
     *
     * @param string $octets octets
     *
     * @return $this
     */
    public function setOctets($octets)
    {
        $this->container['octets'] = $octets;
