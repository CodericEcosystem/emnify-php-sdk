...
/**
 * ActivateBatch Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class ActivateBatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Activate batch';
    ...
    protected static $swaggerTypes = [
        'sim_status' => '\Emnify\EmnifySdk\Model\Status'
    ];
    ...
    {
        $this->container['sim_status'] = isset($data['sim_status']) ? $data['sim_status'] : null;
    }
     ...
     * Sets sim_status
     *
     * @param \Emnify\EmnifySdk\Model\Status $sim_status sim_status
     *
     * @return $this
     */
