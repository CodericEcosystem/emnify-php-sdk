...
/**
 * CreateMFAKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Emnify\EmnifySdk
 * @author   Coderic Development Team
 * @link     https://github.com/CodericEcosystem/emnify-php-sdk
 */
class CreateMFAKeyResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Create MFA Key Response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['otpauth'] = isset($data['otpauth']) ? $data['otpauth'] : null;
     ...
     * @return string
     */
    public function getOtpauth()
    {
        return $this->container['otpauth'];
    }

    /**
     * Sets otpauth
     *
     * @param string $otpauth otpauth
     *
     * @return $this
     */
    public function setOtpauth($otpauth)
    {
        $this->container['otpauth'] = $otpauth;
