...
class MixedPropertiesAndAdditionalPropertiesClass implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'uuid' => 'string',
        'date_time' => '\DateTime',
        'map' => 'map[string,\CodericEcosystem\EmnifySdk\Model\Animal]'
    ];
     ...
     * Gets map
     *
     * @return map[string,\CodericEcosystem\EmnifySdk\Model\Animal]
     */
     ...
     * Sets map
     *
     * @param map[string,\CodericEcosystem\EmnifySdk\Model\Animal] $map map
     *
     * @return $this
     */
