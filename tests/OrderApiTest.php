...
ORDER;
        $order = ObjectSerializer::deserialize(
            ...
            'CodericEcosystem\EmnifySdk\Model\Order'
        );
        
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Order', $order);
...
ORDER;
        ...
        $_order = $order[0][0];
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Order', $_order);
...
ORDER;
        $order = ObjectSerializer::deserialize(
            json_decode($order_json),
            'map[string,map[string,\CodericEcosystem\EmnifySdk\Model\Order]]'
        );
