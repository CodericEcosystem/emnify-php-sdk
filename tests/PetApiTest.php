...
use CodericEcosystem\EmnifySdk\Model\ApiResponse;
...
class PetApiTest extends \PHPUnit_Framework_TestCase
{
     ...
     * $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\InlineResponse200', $response);
    ...
    public function testInheritance()
    {
        ...
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Dog', $new_dog);
        // the object should also be an instance of the parent class
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Animal', $new_dog);
    }
    ...
    public function testArrayStuff()
    {
        ...
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Cat', $farm[1]);
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Dog', $farm[0]);
        $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Animal', $farm[2]);
        ...
        foreach ($farm as $animal) {
            ...
            $this->assertInstanceOf('CodericEcosystem\EmnifySdk\Model\Animal', $animal);
        }
    }
