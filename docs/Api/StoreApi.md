# CodericEcosystem\EmnifySdk\StoreApi
...
$apiInstance = new CodericEcosystem\EmnifySdk\Api\StoreApi(
...
# **getOrderById**
> \CodericEcosystem\EmnifySdk\Model\Order getOrderById($order_id)
...
[**\CodericEcosystem\EmnifySdk\Model\Order**](../Model/Order.md)
...
# **placeOrder**
> \CodericEcosystem\EmnifySdk\Model\Order placeOrder($body)
...
$body = new \CodericEcosystem\EmnifySdk\Model\Order(); // \CodericEcosystem\EmnifySdk\Model\Order | order placed for purchasing the pet
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\CodericEcosystem\EmnifySdk\Model\Order**](../Model/Order.md)| order placed for purchasing the pet |
