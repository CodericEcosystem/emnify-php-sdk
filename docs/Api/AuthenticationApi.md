...
# **authenticate**
> \Swagger\Client\Model\AuthenticationResponse authenticate($body)
...
$body = new \Swagger\Client\Model\Authentication(); // \Swagger\Client\Model\Authentication | Authentication using Application Tokens or user/password combination
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Authentication**](../Model/Authentication.md)| Authentication using Application Tokens or user/password combination |
...
# **postMfa**
> \Swagger\Client\Model\CreateMFAKeyResponse postMfa($body)
...
$body = new \Swagger\Client\Model\UserMfaBody(); // \Swagger\Client\Model\UserMfaBody | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\UserMfaBody**](../Model/UserMfaBody.md)|  |

### Return type

[**\Swagger\Client\Model\CreateMFAKeyResponse**](../Model/CreateMFAKeyResponse.md)
...
$body = new \Swagger\Client\Model\ActivateMFAKeyRequest(); // \Swagger\Client\Model\ActivateMFAKeyRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ActivateMFAKeyRequest**](../Model/ActivateMFAKeyRequest.md)|  |
 **key_id** | **float**| Key ID |
...
# **userMfaStatusGet**
> \Swagger\Client\Model\MFAKeyStatusLookupresponse[] userMfaStatusGet()
...
[**\Swagger\Client\Model\MFAKeyStatusLookupresponse[]**](../Model/MFAKeyStatusLookupresponse.md)
...
> \Swagger\Client\Model\Listoftrusteddevicesresponse[] userMfaTrustedDeviceByUserIdGet($user_id)
...
[**\Swagger\Client\Model\Listoftrusteddevicesresponse[]**](../Model/Listoftrusteddevicesresponse.md)
...
# **userMfaTypeGet**
> \Swagger\Client\Model\MFAKeyTypeLookupresponse[] userMfaTypeGet()
...
[**\Swagger\Client\Model\MFAKeyTypeLookupresponse[]**](../Model/MFAKeyTypeLookupresponse.md)
